      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="menu-text fw-bolder ms-2">Mobile 2</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="<?= base_url(); ?>/table" class="menu-link">
              ...
              <div data-i18n="Analytics">Tabel</div>
            </a>
          </li>

          <li class="menu-item active">
            <a href="<?= base_url(); ?>/uas" class="menu-link">
              <i class="menu-icon tf-icons bx bx-detail"></i>
              <div data-i18n="Analytics">Form</div>
            </a>
          </li>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"> Ujian UAS Mobile 2</h4>
              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <small class="text-muted float-end">Fazeel Muhammad Zuhdi - 1910021</small>
                  </div>
                  <div class="card-body">
                    <form id="tambahData" enctype="multipart/form-data">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="type" name="type" placeholder="Masukan Type" />
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Inputkannn Lokasi" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Foto</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="foto" name="foto" placeholder="Masukan Keterangan" />
                        </div>
                      </div>
  ...
  <script>
    $(document).ready(function() {
      $('#tambahData').submit(function(e) {
        e.preventDefault();
        var formData = $('#tambahData').serialize();

        $.ajax({
          type: "POST",
          url: "<?= base_url(); ?>/uas/simpanData",
          data: formData,
          dataType: "json",
